...
from plugins.screenshot.replace_gui_component import hidden_gui_element, insert_text_image, replace_gui_element_by_other, generate_copied_capture, replace_gui_element_various_places, generate_copied_capture_without_root
